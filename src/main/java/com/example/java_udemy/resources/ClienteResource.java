...
public class ClienteResource {
	...
	@Transactional
	public ResponseEntity<Void> insert (@Valid @RequestBody ClienteNewDTO objDTO){  //RequestBody vai fazer com que o Json seja convertido num Objeto
	...
	public @ResponseBody ResponseEntity<List<ClienteDTO>> findAll() {   
		...
		List<ClienteDTO> listaDTO = lista.stream().map( element ->
		new ClienteDTO(element)).collect(Collectors.toList());  //Cada obj da lista do tipo Cliente vai ser transformada em tipo ClienteDTO
	...
	@RequestMapping(value="/page", method=RequestMethod.GET)  
 	public @ResponseBody ResponseEntity<Page<ClienteDTO>> findPage(
		...
		Page<ClienteDTO> listaDTO = lista.map( element -> new ClienteDTO(element));  //Cada obj da lista do tipo Cliente vai ser transformada em tipo ClienteDTO
